...
import { Plus, Trash2, LogOut, Clock, Zap, FolderOpen, ChevronRight } from 'lucide-react';
      ...
      <header className="sticky top-0 z-40 glass border-b border-border/50">
        <div className="max-w-2xl mx-auto flex items-center justify-between px-4 h-14">
          <div className="flex items-center gap-2">
            ...
            <span className="font-extrabold text-sm tracking-tight">BUNKER AI</span>
          </div>
          <button
            onClick={onLogout}
      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              {projects.length > 0 ? `${projects.length} project${projects.length > 1 ? 's' : ''}` : 'Your workspace'}
            </p>
          </div>
        ...
        {loading ? (
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mb-6">Create your first bunker transformation project</p>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 mt-2">
                          ...
                          <span className="text-xs text-muted-foreground">
                            {STEP_LABELS[proj.current_step as WorkflowStep] || `Step ${proj.current_step}`}
                          </span>
                        </div>
